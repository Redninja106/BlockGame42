...
public unsafe class Keyboard
{
    ...
    {
        int numKeys;
        CBool* keys = SDL_GetKeyboardState(&numKeys);
        return new KeyboardState() { keys = keys, numKeys = numKeys };
    }
}
...
public unsafe struct KeyboardState
{
    ...
    public bool this[Scancode scancode]
    {
        get
        {
            if ((uint)scancode >= numKeys)
            {
                throw new IndexOutOfRangeException();
            }

            return keys[(uint)scancode];
        }
    }
